...
<a href="https://wef4build.upc.edu/en" target="_blank" style="text-decoration:none;">
...
">
  ...
  ">
    ...
    https://wef4build.upc.edu/en
  </div>

  <!-- preview image -->
  {% include figure.liquid
        path="assets/img/projects/wef4build_preview.png"
        class="img-fluid"
        sizes="100vw"
        loading="eager"
  %}
...
Click the window above for more information about the WEF4BUILD project. 
</p>
